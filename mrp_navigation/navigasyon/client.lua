...
Instance = {
	...
	find = function(self)
		...
		self.window = guiCreateWindow(0, 0, 510, 333, "MelanciaMTA | Navigasyon Sistemi", false)
		exports.mrp_global:centerWindow(self.window)
                ...
                addEventHandler('onClientGUIClick', ok,
                	function(b, s)
                                ...
                                if selectedRow ~= -1 then
                                       ...
                                       exports.mrp_navigation:findBestWay(Locations[selectedJob][2][1], Locations[selectedJob][2][2], Locations[selectedJob][2][3])
                                end
                	end
                )
