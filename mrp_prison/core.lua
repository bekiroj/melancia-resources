...
sPrison = {
	...
	region = ColShape.Sphere(1577.1484375, -1648.23046875, 12.1796875, 3),

	pickup = Pickup(1577.1484375, -1648.23046875, 12.1796875, 3, 1239),
	...
	sPrison = instance;
		if player:getData('faction') == 1 or player:getData('faction') == 78 then
			if targetPlayerName and tonumber(time) and ... then
				local targetPlayer, targetPlayerName = exports.mrp_global:findPlayerByPartialNick(player, targetPlayerName)
	...
	_timer = function()
		for index, value in ipairs(exports.mrp_pool:getPoolElementsByType("player")) do
