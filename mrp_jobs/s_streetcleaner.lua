...
function initiateCleanerJob(thePlayer)
	...
	exports.mrp_pool:allocateElement(blip)
...
function startCleaningMission(thePlayer)
	if (isElement(thePlayer)) then
		...
		exports.mrp_pool:allocateElement(vehicle)
			
		exports.mrp_anticheat:changeProtectedElementDataEx(vehicle, "fuel", 100)
		exports.mrp_anticheat:changeProtectedElementDataEx(vehicle, "owner", -2, false)
		exports.mrp_anticheat:changeProtectedElementDataEx(vehicle, "faction", -1, false)
		exports.mrp_anticheat:changeProtectedElementDataEx(vehicle, "dbid", 999999, false)
		exports.mrp_anticheat:changeProtectedElementDataEx(vehicle, "oldx", 1503.5179443359, false)
		exports.mrp_anticheat:changeProtectedElementDataEx(vehicle, "oldy", 369.0305175781, false)
		exports.mrp_anticheat:changeProtectedElementDataEx(vehicle, "oldz", 10.8203125, false)
		exports.mrp_anticheat:changeProtectedElementDataEx(vehicle, "engine", 1, false)
		removePedFromVehicle(thePlayer)
		warpPedIntoVehicle(thePlayer, vehicle)
		
		exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "cleaner.marker", "1")
		exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "cleaner.vehicle", vehicle)
		...
		if tonumber(int) == 1 then
			...
			exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "cleaner.checkmarkers", "25")
			exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "cleaner.t", "1")
		elseif tonumber(int) == 2 then
			x1 = CheckpointStyle_2[1].x_point
			y1 = CheckpointStyle_2[1].y_point
			z1 = CheckpointStyle_2[1].z_point
			exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "cleaner.checkmarkers", "17")
			exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "cleaner.t", "2")
		elseif tonumber(int) == 3 then
			x1 = CheckpointStyle_3[1].x_point
			y1 = CheckpointStyle_3[1].y_point
			z1 = CheckpointStyle_3[1].z_point
			exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "cleaner.checkmarkers", "17")
			exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "cleaner.t", "3")
		end																				--- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<
		local blip2 = createBlip(x1 ,y1 ,z1, 0, 2, 255, 0, 255, 255)
		local marker2 = createMarker(x1 ,y1 ,z1 , "checkpoint", 4, 255, 0, 255, 150)
		exports.mrp_pool:allocateElement(blip2)
		exports.mrp_pool:allocateElement(marker2)
		...
		exports.mrp_pool:allocateElement(colsphere)
		attachElements ( marker2, blip2 )
		exports.mrp_anticheat:changeProtectedElementDataEx(colsphere, "attatched", marker2)
	...
	if ( isPedInVehicle ( thePlayer ) ) then
		...
		if tonumber(vehid) == 574 then
			...
			if tonumber(max_number) == tonumber(m_number) then
				...
				exports.mrp_pool:allocateElement(marker3)
				exports.mrp_pool:allocateElement(blip3)
				...
				exports.mrp_anticheat:changeProtectedElementDataEx(colsphere, "attatched", marker3)
				
				addEventHandler("onColShapeHit", colsphere, FinalCheckpoints)
			else
				local newnumber = m_number+1
				exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "cleaner.marker", newnumber)
...
function FinalCheckpoints( thePlayer )
	if ( isPedInVehicle ( thePlayer ) ) then
		...
		if tonumber(vehid) == 574 then
			...
			exports.mrp_pool:allocateElement(marker4)
			exports.mrp_pool:allocateElement(blip4)
			...
			exports.mrp_anticheat:changeProtectedElementDataEx(colsphere, "attatched", marker4)
	...
	if (isElement(thePlayer)) then
		if ( isPedInVehicle ( thePlayer ) ) then
			...
			if tonumber(vehid) == 574 then
				...
				exports.mrp_anticheat:changeProtectedElementDataEx(vehicle, "fuel")
				exports.mrp_anticheat:changeProtectedElementDataEx(vehicle, "dbid")
				
				if (isElement(vehicle)) then
					destroyElement(vehicle)
					vehicle = nil
					exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "cleaner.vehicle")
					...
					exports.mrp_global:giveMoney(thePlayer, 300)
...
function quit()
	...
	exports.mrp_anticheat:changeProtectedElementDataEx(source, "cleaner.vehicle")
end
