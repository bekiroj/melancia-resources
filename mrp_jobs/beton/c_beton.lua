...
function betonBlip()
	...
	exports.mrp_hud:sendBottomNotification(localPlayer, "Beton Taşımacılığı Şoförü", "Haritadaki sarı işarete giderek Beton Taşımacılığı şoförlüğü mesleğinize başlayabilirsiniz.")
end