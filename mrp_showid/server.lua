	...
	if not (targetPlayer) then
				...
				if targetPlayer then
					...
					if not getElementData(thePlayer, "kimlik") == true then
						...
						if distance < 3 then
	                		exports.mrp_hud:sendBottomNotification(targetPlayer, "Aşağıdakiler '"..username.."' isimli kişinin kimlik bilgileridir.", "Adı ve Soyadı: "..getPlayerName(thePlayer):gsub("_", " ").." | Cinsiyeti: "..cinsiyet.." | Dogum tarihi: Gün: "..gun.." Ay: "..ay..": Yaş: "..yas)
