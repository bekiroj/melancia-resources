...
local preview = exports["mrp_object_preview"]
...
addEventHandler("onClientRender", root,
	function()
		...
		dxDrawText("Aksesuar Mağazası - Melancia", x, y, w+x, 25+y, tocolor(255, 255, 255), 1, font, "center", "center")
