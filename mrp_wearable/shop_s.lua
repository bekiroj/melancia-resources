...
addEventHandler("wearable.buyItem", root,
    function(player, modelID, price)
        local syntax = exports.mrp_pool:getServerSyntax(false, "w");
        local boneTable, bone = findThemBonePosition(modelID);
        if exports.mrp_global:hasMoney(player, price) then
            if exports.mrp_global:takeMoney(player, price) then
