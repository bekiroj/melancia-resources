...
if not exports["mrp_items"]:hasItem(plr,66) then outputChatBox("[!]#ffffff Maalesef üzerinizde bandaj yok.",plr,255,100,100,true) return end
	...
	if target then
		...
		exports["mrp_items"]:takeItem(plr, 66)
	end
end)
