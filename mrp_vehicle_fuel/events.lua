						...
						if engine == 1 then
							...
							if fuel >= 1 then
								...
								if not ignore then
									...
									exports.mrp_anticheat:changeProtectedElementDataEx(veh, "fuel", newFuel, false)
		...
		if (enginestatus == 1) then
			...
			if (driver == false) then
				...
				if fuel >= 1 then
					...
					exports.mrp_anticheat:changeProtectedElementDataEx(theVehicle, "fuel", newFuel, false)
					if (newFuel<=1) then
						setVehicleEngineState(theVehicle, false)
						exports.mrp_anticheat:changeProtectedElementDataEx(theVehicle, "engine", 0, false)
					end
				end
			end
		end
