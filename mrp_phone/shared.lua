function loadFonts()
    fonts = {
        [1] = DxFont("components/fonts/rbold.ttf", 11),
        [2] = DxFont("components/fonts/rregular.ttf", 9),
        [3] = DxFont(":mrp_fonts/files/RobotoL.ttf", 12),
        [4] = DxFont(":mrp_fonts/files/RobotoL.ttf", 10),
        [5] = DxFont(":mrp_fonts/files/RobotoL.ttf", 9),
        [6] = DxFont(":mrp_fonts/files/RobotoL.ttf", 6),
        [7] = GuiFont(":mrp_fonts/files/RobotoL.ttf", 10),
        [8] = DxFont(":mrp_fonts/files/RobotoL.ttf", 8.4),
        [9] = DxFont(":mrp_fonts/files/FontAwesome5.ttf", 10),
        [10] = DxFont(":mrp_fonts/files/FontAwesome.ttf", 7),
        [11] = DxFont(":mrp_fonts/files/Roboto-Regular.ttf", 10),
        [12] = DxFont(":mrp_fonts/files/RobotoB.ttf", 10),
        [13] = DxFont(":mrp_fonts/files/FontAwesome.ttf", 10),
        --[11] = DxFont("components/fonts/arialbd.ttf", 9.5),
    }
end

addEventHandler("onClientResourceStart", root,
    function(startedRes)
        if getResourceName(startedRes) == "mrp_fonts" then
            loadFonts()
        end
    end
)
