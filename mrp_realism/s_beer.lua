...
addEventHandler("realism:startdrinking", getRootElement(),
	function(hand)
		...
		exports.mrp_anticheat:changeProtectedElementDataEx(source, "realism:drinking", true, false )
		exports.mrp_anticheat:changeProtectedElementDataEx(source, "realism:drinking:hand", hand, false )
...
function stopdrinking(thePlayer)
	...
	if (isElement(thePlayer)) then	
		...
		if (isdrinking) then
			...
			exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "realism:drinking", false, false )
		end
	end
end
...
function stopdrinkingCMD(thePlayer)
	...
	if (isdrinking) then
		...
		exports.mrp_global:sendLocalMeAction(thePlayer, "throws their beerette on the ground.")
	end
end
