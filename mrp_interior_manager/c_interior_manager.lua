...
function createIntManagerWindow(IntsList)
	...
	if (IntsList) then
		...
		--IntsList1 = IntsList
		gWin = guiCreateWindow(sx/2-400,sy/2-300,800,600,"İnterior Arayüzü",false)
...
function createCheckIntWindow(result, adminTitle, history, notes1)
	...
	local lSupplies = guiCreateLabel(372,95,163,17,"Supplies: ",false,checkIntWindow)
	...
	guiSetText(lSupplies, "Supplies: "..result[1][10] or "")
