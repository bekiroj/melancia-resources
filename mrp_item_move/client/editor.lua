...
local function canEditObject( object )
  return exports.mrp_integration:isStaffOnDuty(localPlayer) or exports.mrp_integration:isPlayerScripter(localPlayer)
end
...
addEventHandler('item:move', root,
  function(object)
    ...
    if editing and object then
      ...
      if exports.mrp_integration:isPlayerTrialAdmin(localPlayer) then
        bProtect = guiCreateButton( 5, 200, 65, 20, 'Koru', false, wInfo )
      ...
      bSave = guiCreateButton( 145, 200, 65, 20, 'Kaydet', false, wInfo )
      ...
      bClose = guiCreateButton( 215, 200, 30, 20, 'Kapat', false, wInfo )
      ...
      local controls = guiCreateLabel( 15, 225, 240, 40, "Hareket: WASDF, Yön Yukarı/Aşağı\nRotasyon: Yön Sol/Sağ", false, wInfo )
