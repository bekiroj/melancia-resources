...
local function playGunfireSound(weaponID)
	...
	if weaponID == 22 then --colt45
		local sound = playSound3D("components/weap/Colt45.wav", muzzleX, muzzleY, muzzleZ, false)
		setSoundMaxDistance(sound, 95)
		setElementDimension(sound, dim)
		setSoundVolume(sound, 0.3)
	elseif weaponID == 23 then
		local sound = playSound3D("components/weap/Silenced.wav", muzzleX, muzzleY, muzzleZ, false)
	...
	elseif weaponID == 24 then--deagle
		...
		if mode == 0 then
			sound = playSound3D("components/weap/Tazer.wav", muzzleX, muzzleY, muzzleZ, false)
		else
			sound = playSound3D("components/weap/Deagle.wav", muzzleX, muzzleY, muzzleZ, false)
			setSoundVolume(sound, 0.3)
		end
	...
	elseif weaponID == 25 then--shotgun
		...
		if mode == 0 then
			sound = playSound3D("components/weap/beanbag.wav", muzzleX, muzzleY, muzzleZ, false)
		else
			sound = playSound3D("components/weap/Shotgun.wav", muzzleX, muzzleY, muzzleZ, false)
			setSoundVolume(sound, 0.3)
		end
		setSoundMaxDistance(sound, 120)
		setElementDimension(sound, dim)
	elseif weaponID == 26 then--sawn-off
		local sound = playSound3D("components/weap/Sawed-Off.wav", muzzleX, muzzleY, muzzleZ, false)
		setSoundMaxDistance(sound, 95)
		setElementDimension(sound, dim)
		setSoundVolume(sound, 0.3)
	elseif weaponID == 27 then--combat shotgun
		local sound = playSound3D("components/weap/CombatShgun.wav", muzzleX, muzzleY, muzzleZ, false)
		setSoundMaxDistance(sound, 100)
		setElementDimension(sound, dim)
		setSoundVolume(sound, 0.3)
	elseif weaponID == 28 then--uzi
		local sound = playSound3D("components/weap/UZI.wav", muzzleX, muzzleY, muzzleZ, false)
		setSoundMaxDistance(sound, 105)
		setElementDimension(sound, dim)
		setSoundVolume(sound, 0.3)
	elseif weaponID == 32 then--tec-9
		local sound = playSound3D("components/weap/tec9.wav", muzzleX, muzzleY, muzzleZ, false)
		setSoundMaxDistance(sound, 105)
		setElementDimension(sound, dim)
		setSoundVolume(sound, 0.3)
	elseif weaponID == 29 then--mp5
		local sound = playSound3D("components/weap/MP5.wav", muzzleX, muzzleY, muzzleZ, false)
		setSoundMaxDistance(sound, 120)
		setElementDimension(sound, dim)
		setSoundVolume(sound, 0.3)
	elseif weaponID == 30 then--AK-47
		local sound = playSound3D("components/weap/AK-47.wav", muzzleX, muzzleY, muzzleZ, false)
        setSoundMaxDistance(sound, 120)
        setElementDimension(sound, dim)
        setSoundVolume(sound, 0.3)
	elseif weaponID == 31 then--m4
		local sound = playSound3D("components/weap/M4.wav", muzzleX, muzzleY, muzzleZ, false)
		setSoundMaxDistance(sound, 170)
		setElementDimension(sound, dim)
		setSoundVolume(sound, 0.3)
	elseif weaponID == 33 then--rifle
		local sound = playSound3D("components/weap/Rifle.wav", muzzleX, muzzleY, muzzleZ, false)
		setSoundMaxDistance(sound, 175)
		setElementDimension(sound, dim)
		setSoundVolume(sound, 0.3)
	elseif weaponID == 34 then--sniper
		local sound = playSound3D("components/weap/Sniper.wav", muzzleX, muzzleY, muzzleZ, false)
