...
function frames_showTexGUI ( )
	...
	if interiorID >= 1 or (exports.mrp_integration:isPlayerSeniorAdmin(localPlayer) and exports.mrp_global:isAdminOnDuty(localPlayer)) or exports.mrp_integration:isPlayerScripter(localPlayer) then
		if exports.mrp_global:hasItem ( localPlayer, 4, interiorID ) or exports.mrp_global:hasItem ( localPlayer, 5, interiorID ) or (exports.mrp_integration:isPlayerAdmin(localPlayer) and exports.mrp_global:isAdminOnDuty(localPlayer)) or (interiorID==0) then
			if not gui.window then
				...
				if(not exports.mrp_global:hasItem(localPlayer, 4, interiorID) and not exports.mrp_global:hasItem(localPlayer, 5, interiorID)) then
