...
function updateNametagColor(thePlayer)
	...
	elseif exports.mrp_integration:isPlayerTrialAdmin(thePlayer) and getElementData(thePlayer, "duty_admin") == 1 and getElementData(thePlayer, "hiddenadmin") == 0 then -- Admin on duty
		setPlayerNametagColor(thePlayer,  242, 9, 9)
	elseif exports.mrp_integration:isPlayerSupporter(thePlayer) and (getElementData(thePlayer, "duty_supporter") == 1) and getElementData(thePlayer, "hiddenadmin") == 0 then 
	...
	for index, value in pairs(exports["mrp_items"]:getBadges()) do
