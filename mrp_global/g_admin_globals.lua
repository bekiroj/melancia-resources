function getAdminTitles()
	return exports.mrp_integration:getAdminTitles()
end
...
function getPlayerAdminTitle(thePlayer)
	if isElement(thePlayer) then
		if exports.mrp_integration:isPlayerIA( thePlayer ) then
		...
		if exports.mrp_integration:isPlayerTrialAdmin(thePlayer) then
			...
			return text
		elseif exports.mrp_integration:isPlayerSupporter(thePlayer) then
			return "Rehber"
		elseif exports.mrp_integration:isPlayerLeadScripter(thePlayer) then
			return "Scripter"
		elseif exports.mrp_integration:isPlayerScripter(thePlayer) then
			return "Trial Scripter"
		elseif exports.mrp_integration:isPlayerVCTMember(thePlayer) then
			return "Vehicle Consultation Member"
		elseif exports.mrp_integration:isPlayerVehicleConsultant(thePlayer) then
			return "Vehicle Consultation Leader"
		elseif exports.mrp_integration:isPlayerMappingTeamMember(thePlayer) then
			return "Mapper"
		else
			return "Player"
		end
...
function isPlayerScripter(thePlayer)
	return exports["mrp_integration"]:isPlayerScripter(thePlayer)
end
...
function isStaff(thePlayer)
	if thePlayer and isElement(thePlayer) and getElementType(thePlayer) == "player" then
		return exports.mrp_integration:isPlayerTrialAdmin(thePlayer) or exports.mrp_integration:isPlayerSupporter(thePlayer)
	else
		return false
	end
end
...
function isAdminOnDuty(thePlayer)
	if thePlayer and isElement(thePlayer) and getElementType(thePlayer) == "player" then
		return exports.mrp_integration:isPlayerTrialAdmin(thePlayer) and (getElementData(thePlayer, "duty_admin") == 1)
	else
		return false
	end
end
...
function isSupporterOnDuty(thePlayer)
	if thePlayer and isElement(thePlayer) and getElementType(thePlayer) == "player" then
		return exports.mrp_integration:isPlayerSupporter(thePlayer) and (getElementData(thePlayer, "duty_supporter") == 1)
	else
		return false
	end
end
