...
function forcedAnim()
	if isPedInVehicle(source) or getElementData(source, "dead") == 1 then return false end 
	exports.mrp_anticheat:changeProtectedElementDataEx(source, "forcedanimation", 1, false)
end
...
function unforcedAnim()
	if isPedInVehicle(source) or getElementData(source, "dead") == 1 then return false end 
	exports.mrp_anticheat:changeProtectedElementDataEx(source, "forcedanimation", 0, false)
end
...
function coverAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "ped", "duck_cower", -1, false, false, false)
	end
end
...
function sertkonusAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "benchpress", "gym_bp_celebrate", -1, false, false, false)
	end
end
...
function cprAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "medic", "cpr", 8000, false, true, false)
	end
end
...
function elsallaAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "ON_LOOKERS", "wave_loop", -1, true, true, false)
	end
end
...
function drugAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "DEALER", "DRUGS_BUY", 8000, false, true, false)
	end
end
...
function kostomachAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "ped", "KO_shot_stom", -1, false, true, false)
	end
end
...
function copawayAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "police", "coptraf_away", 1300, true, false, false)
	end
end
...
function copcomeAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "POLICE", "CopTraf_Come", -1, true, false, false)
	end
end
...
function copleftAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "POLICE", "CopTraf_Left", -1, true, false, false)
	end
end
...
function copstopAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "POLICE", "CopTraf_Stop", -1, true, false, false)
	end
end
...
function durusAnimation(thePlayer)
	...
	if (logged==1) then
	if arg == 2 then
			exports.mrp_global:applyAnimation(thePlayer, "ped", "XPRESSscratch", -1, true, false, false)
		elseif arg == 3 then
		exports.mrp_global:applyAnimation(thePlayer, "DEALER", "DEALER_IDLE_01", -1, true, false, false)
		else
		exports.mrp_global:applyAnimation(thePlayer, "ped", "XPRESSscratch", -1, true, false, false)
...
function pedWait(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "COP_AMBIENT", "Coplook_loop", -1, true, false, false)
	end
end
...
function driveBy1(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "DRIVEBYS", "Gang_DrivebyRHS_Bwd", -1, true, false, false)
	end
end
...
function pedThink(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "COP_AMBIENT", "Coplook_think", -1, true, false, false)
	end
end
...
function pedShake(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "COP_AMBIENT", "Coplook_shake", -1, true, false, false)
	end
end
...
function idleAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "DEALER", "DEALER_IDLE_01", -1, true, false, true)
	end
end
...
function idle1Animation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "DEALER", "DEALER_IDLE", -1, true, false, false)
	end
end
...
function gsign1Animation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "GHANDS", "gsign1", -1, true, false, false)
	end
end
...
function gsign2Animation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "GHANDS", "gsign1LH", -1, true, false, false)
	end
end
...
function gsign3Animation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "GHANDS", "gsign2LH", -1, true, false, false)
	end
end
...
function pedPiss(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "PAULNMAC", "Piss_loop", -1, true, false, false)
	end
end
...
function pedWank(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "PAULNMAC", "wank_loop", -1, true, false, false)
	end
end
...
function pedSlapAss(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "SWEET", "sweet_ass_slap", 2000, true, false, false)
	end
end
...
function pedCarFix(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "CAR", "Fixn_Car_loop", -1, true, false, false)
	end
end
...
function pedHandsup(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "ped", "handsup", -1, false, false, false)
	end
end
...
function pedTaxiHail(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "MISC", "Hiker_Pose", -1, false, true, false)
	end
end
...
function pedScratch(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "MISC", "Scratchballs_01", -1, true, true, false)
	end
end
...
function pedFU(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "RIOT", "RIOT_FUKU", 800, false, true, false)
	end
end
...
function pedStrip( thePlayer, cmd, arg )
	...
	if (logged==1) then
		if arg == 2 then
			exports.mrp_global:applyAnimation( thePlayer, "STRIP", "STR_Loop_C", -1, false, true, false)
		else
			exports.mrp_global:applyAnimation( thePlayer, "STRIP", "strip_D", -1, false, true, false)
		end
	end
end
...
function pedLightup (thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "SMOKING", "M_smk_in", 4000, true, true, false)
	end
end
...
function pedHeil (thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "ON_LOOKERS", "Pointup_in", 999999, false, true, false)
	end
end
...
function pedDrink( thePlayer )
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "BAR", "dnk_stndM_loop", 2300, false, false, false)
	end
end
...
function pedLay( thePlayer, cmd, arg )
	...
	if (logged==1) then
		if arg == 2 then
			exports.mrp_global:applyAnimation( thePlayer, "BEACH", "sitnwait_Loop_W", -1, true, false, false)
		else
			exports.mrp_global:applyAnimation( thePlayer, "BEACH", "Lay_Bac_Loop", -1, true, false, false)
		end
	end
end
...
function begAnimation( thePlayer )
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "SHOP", "SHP_Rob_React", 4000, true, false, false)
	end
end
...
function pedMourn( thePlayer )
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "GRAVEYARD", "mrnM_loop", -1, true, false, false)
	end
end
...
function pedCry( thePlayer )
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "GRAVEYARD", "mrnF_loop", -1, true, false, false)
	end
end
...
function pedCheer(thePlayer, cmd, arg)
	...
	if (logged==1) then
		if arg == 2 then
			exports.mrp_global:applyAnimation( thePlayer, "OTB", "wtchrace_win", -1, true, false, false)
		elseif arg == 3 then
			exports.mrp_global:applyAnimation( thePlayer, "RIOT", "RIOT_shout", -1, true, false, false)
		else
			exports.mrp_global:applyAnimation( thePlayer, "STRIP", "PUN_HOLLER", -1, true, false, false)
		end
	end
end
...
function danceAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		if arg == 2 then
			exports.mrp_global:applyAnimation( thePlayer, "DANCING", "DAN_Down_A", -1, true, false, false)
		elseif arg == 3 then
			exports.mrp_global:applyAnimation( thePlayer, "DANCING", "dnce_M_d", -1, true, false, false)
		else
			exports.mrp_global:applyAnimation( thePlayer, "DANCING", "DAN_Right_A", -1, true, false, false)
		end
	end
end
...
function crackAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		if arg == 2 then
			exports.mrp_global:applyAnimation( thePlayer, "CRACK", "crckidle1", -1, true, false, false)
		elseif arg == 3 then
			exports.mrp_global:applyAnimation( thePlayer, "CRACK", "crckidle3", -1, true, false, false)
		elseif arg == 4 then
			exports.mrp_global:applyAnimation( thePlayer, "CRACK", "crckidle4", -1, true, false, false)
		else
			exports.mrp_global:applyAnimation( thePlayer, "CRACK", "crckidle2", -1, true, false, false)
		end
	end
end
...
function gsignAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		if arg == 2 then
			exports.mrp_global:applyAnimation(thePlayer, "GHANDS", "gsign2", 4000, true, false, false)
		elseif arg == 3 then
			exports.mrp_global:applyAnimation(thePlayer, "GHANDS", "gsign3", 4000, true, false, false)
		elseif arg == 4 then
			exports.mrp_global:applyAnimation(thePlayer, "GHANDS", "gsign4", 4000, true, false, false)
		elseif arg == 5 then
			exports.mrp_global:applyAnimation(thePlayer, "GHANDS", "gsign5", 4000, true, false, false)
		else
			exports.mrp_global:applyAnimation(thePlayer, "GHANDS", "gsign1", 4000, true, false, false)
		end
	end
end
...
function pukeAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "FOOD", "EAT_Vomit_P", 8000, true, false, false)
	end
end
...
function rapAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		if arg == 2 then
			exports.mrp_global:applyAnimation( thePlayer, "LOWRIDER", "RAP_B_Loop", -1, true, false, false)
		elseif arg == 3 then
			exports.mrp_global:applyAnimation( thePlayer, "LOWRIDER", "RAP_C_Loop", -1, true, false, false)
		else
			exports.mrp_global:applyAnimation( thePlayer, "LOWRIDER", "RAP_A_Loop", -1, true, false, false)
		end
	end
end
...
function aimAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "SHOP", "ROB_Loop_Threat", -1, false, true, false)
	end
end
...
function sitAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		if isPedInVehicle( thePlayer ) then
			...
			--end
			if arg == 2 then
				exports.mrp_global:applyAnimation( thePlayer, "FOOD", "FF_Sit_Look", -1, true, false, false)
			elseif arg == 3 then
				exports.mrp_global:applyAnimation( thePlayer, "Attractors", "Stepsit_loop", -1, true, false, false)
			elseif arg == 4 then
				exports.mrp_global:applyAnimation( thePlayer, "BEACH", "ParkSit_W_loop", 1, true, false, false)
			elseif arg == 5 then
				exports.mrp_global:applyAnimation( thePlayer, "BEACH", "ParkSit_M_loop", 1, true, false, false)
			elseif arg == 6 then
				exports.mrp_global:applyAnimation( thePlayer, "BLOWJOBZ", "BJ_Couch_Loop_P", -1, true, false, false)
			elseif arg == 7 then
				exports.mrp_global:applyAnimation( thePlayer, "JST_BUISNESS", "girl_02", -1, true, false, false)
			elseif arg == 8 then
			--	exports.mrp_global:applyAnimation( thePlayer, "SWAT", "JMP_Wall1m_180", 1, false, false, false)
				triggerClientEvent(thePlayer, "sync:anim", thePlayer, "oturn1")
			else
				exports.mrp_global:applyAnimation( thePlayer, "ped", "SEAT_idle", -1, true, false, false)
			end
		end
	end
end
...
function smokeAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		if arg == 2 then
			exports.mrp_global:applyAnimation( thePlayer, "SMOKING", "M_smkstnd_loop", -1, true, false, false)
		elseif arg == 3 then
			exports.mrp_global:applyAnimation( thePlayer, "LOWRIDER", "M_smkstnd_loop", -1, true, false, false)
		else
			exports.mrp_global:applyAnimation( thePlayer, "GANGS", "smkcig_prtl", -1, true, false, false)
		end
	end
end
addCommandHandler("smoke", smokeAnimation, false, false)
	exports.mrp_global:applyAnimation( thePlayer, "GANGS", "hndshkfa", -1, false, false, false)
					exports.mrp_global:applyAnimation( otherPlayer, "GANGS", "hndshkfa", -1, false, false, false)
-- /smokelean animtion -------------------------------------------------
function smokeleanAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "LOWRIDER", "M_smklean_loop", -1, true, false, false)
	end
end
...
function smokedragAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "SMOKING", "M_smk_drag", 4000, true, false, false)
	end
end
...
function laughAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "RAPPING", "Laugh_01", -1, true, false, false)
	end
end
...
function startraceAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "CAR", "flag_drop", 4200, true, false, false)
	end
end
...
function carchatAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "CAR_CHAT", "car_talkm_loop", -1, true, false, false)
	end
end
...
function tiredAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "FAT", "idle_tired", -1, true, false, false)
	end
end
...
function handshakeAnimation(thePlayer, cmd, otherGuy)
	...
	if (logged==1) then
		if otherGuy then
			local otherPlayer = exports.mrp_global:findPlayerByPartialNick(thePlayer, otherGuy)
			if otherPlayer then
...
function shoveAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "GANGS", "shake_carSH", -1, true, false, false)
	end
end
...
function bitchslapAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "MISC", "bitchslap", -1, true, false, false)
	end
end
...
function shockedAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "ON_LOOKERS", "panic_loop", -1, true, false, false)
	end
end
...
function diveAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation(thePlayer, "ped", "EV_dive", -1, false, true, false)
	end
end
...
function whatAnimation(thePlayer)
	...
	if (logged==1) then
		...
		exports.mrp_global:applyAnimation( thePlayer, "RIOT", "RIOT_ANGRY", -1, true, false, false)
	end
end
...
function polisoturAnimation(thePlayer)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "CAMERA", "camcrch_idleloop", -1, true, false, false)
	end
end
...
function fallfrontAnimation(thePlayer)
	...
	if (logged==1) then
		...
		spamTimers[thePlayer] = setTimer(function() end, 3 * 1000, 1)
		exports.mrp_global:applyAnimation( thePlayer, "ped", "FLOOR_hit_f", -1, false, false, false)
	end
end
...
function fallAnimation(thePlayer)
	...
	if (logged==1) then
		...
		spamTimers[thePlayer] = setTimer(function() end, 3 * 1000, 1)
		exports.mrp_global:applyAnimation( thePlayer, "ped", "FLOOR_hit", -1, false, false, false)
	end
end
...
function walkAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		...
		exports.mrp_global:applyAnimation( thePlayer, "PED", walk[arg], -1, true, true, false)
...
function batAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		if arg == 2 then
			exports.mrp_global:applyAnimation( thePlayer, "CRACK", "Bbalbat_Idle_02", -1, true, false, false)
		elseif arg == 3 then
			exports.mrp_global:applyAnimation( thePlayer, "Baseball", "Bat_IDLE", -1, true, false, false)
		else
			exports.mrp_global:applyAnimation( thePlayer, "CRACK", "Bbalbat_Idle_01", -1, true, false, false)
		end
	end
end
...
function winAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		if arg == 2 then
			exports.mrp_global:applyAnimation( thePlayer, "CASINO", "manwinb", 2000, false, false, false)
		else
			exports.mrp_global:applyAnimation( thePlayer, "CASINO", "manwind", 2000, false, false, false)
		end
	end
end
...
function kickballsAnimation(thePlayer, cmd, arg)
	...
	local logged = getElementData(thePlayer, "loggedin")
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "FIGHT_E", "FightKick_B", 1, false, false, false)
	end
end
...
function asilAnimation(thePlayer, cmd, arg)
	...
	local logged = getElementData(thePlayer, "loggedin")
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "BSKTBALL", "BBALL_Dnk", 1, false, false, false)
	end
end
...
function grabbAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "BAR", "Barserve_bottle", 2000, false, false, false)
	end
end
...
function taichiAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "PARK", "Tai_Chi_Loop", -1, false, false, false)
	end
end
...
function bompAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "BOMBER", "BOM_Plant", -1, false, false, false)
	end
end
...
function kartopuAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "GRENADE", "WEAPON_throw", -1, false, false, false)
	end
end
...
function kapakAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "GANGS", "hndshkaa", -1, false, false, false)
	end
end
...
function kollariniac(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "BSKTBALL", "BBALL_def_loop", -1, false, false, false)
	end
end
...
function sikerimAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "GANGS", "hndshkba", -1, false, false, false)
	end
end
...
function teklifhayirAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "GANGS", "Invite_No", -1, false, false, false)
	end
end
...
function teklifevetAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "GANGS", "Invite_Yes", -1, false, false, false)
	end
end
...
function sohbet1Animation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "GANGS", "prtial_gngtlkA", -1, false, false, false)
	end
end
...
function sohbet2Animation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "GANGS", "prtial_gngtlkB", -1, false, false, false)
	end
end
...
function sohbet3Animation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "GANGS", "prtial_gngtlkC", -1, false, false, false)
	end
end
...
function sohbet4Animation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "GANGS", "prtial_gngtlkD", -1, false, false, false)
	end
end
...
function sohbet5Animation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "GANGS", "prtial_gngtlkE", -1, false, false, false)
	end
end
...
function sohbet6Animation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "GANGS", "prtial_gngtlkF", -1, false, false, false)
	end
end
...
function bar1Animation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.mrp_global:applyAnimation( thePlayer, "BAR", "Barcustom_get", -1, false, false, false)
	end
end
...
function yaslanmaAnimasyonlari(thePlayer, cmd, arg)
	...
	source = thePlayer
		if arg == 2 then
			exports.mrp_global:applyAnimation( thePlayer, "BAR", "BARman_idle", -1, true, false, false)
		elseif arg == 3 then
			exports.mrp_global:applyAnimation( thePlayer, "Attractors", "Stepsit_loop", -1, true, false, false)
		else
			exports.mrp_global:applyAnimation( thePlayer, "GANGS", "leanIDLE", -1, true, false, false)
		end
	end
end
...
function kissingAnimation( thePlayer, commandName, target )
	...
	local targetPlayer = exports.mrp_global:findPlayerByPartialNick(thePlayer, target)
	...
	if (getDistanceBetweenPoints3D(x, y, z, tx, ty, tz)<1) and getPedOccupiedVehicle(thePlayer) == false and getPedOccupiedVehicle(targetPlayer) == false then
		exports.mrp_global:applyAnimation( thePlayer, "KISSING", "Grlfrd_Kiss_01", -1, false, false, false )
		exports.mrp_global:applyAnimation( targetPlayer, "KISSING", "Grlfrd_Kiss_01", -1, false, false, false )
	end
end
...
function kselamAnimation( thePlayer, commandName, target )
	...
	local tx, ty, tz = getElementPosition(targetPlayer)
	if (getDistanceBetweenPoints3D(x, y, z, tx, ty, tz)<1) and getPedOccupiedVehicle(thePlayer) == false and getPedOccupiedVehicle(targetPlayer) == false then
			exports.mrp_global:applyAnimation( thePlayer, "GANGS", "prtial_hndshk_biz_01", -1, false, false, false )
		exports.mrp_global:applyAnimation( targetPlayer, "GANGS", "prtial_hndshk_biz_01", -1, false, false, false )
	end
end
...
function ysexAnimation( thePlayer, commandName, target )
	...
	local tx, ty, tz = getElementPosition(targetPlayer)
	if (getDistanceBetweenPoints3D(x, y, z, tx, ty, tz)<1) and getPedOccupiedVehicle(thePlayer) == false and getPedOccupiedVehicle(targetPlayer) == false then
			exports.mrp_global:applyAnimation( thePlayer, "BLOWJOBZ", "BJ_Couch_End_P", -1, false, false, false )
		exports.mrp_global:applyAnimation( targetPlayer, "BLOWJOBZ", "BJ_Couch_End_W", -1, false, false, false )
	end
end
...
function ysex2Animation( thePlayer, commandName, target )
	...
	local tx, ty, tz = getElementPosition(targetPlayer)
	if (getDistanceBetweenPoints3D(x, y, z, tx, ty, tz)<1) and getPedOccupiedVehicle(thePlayer) == false and getPedOccupiedVehicle(targetPlayer) == false then
			exports.mrp_global:applyAnimation( thePlayer, "BLOWJOBZ", "BJ_Couch_Loop_P", -1, false, false, false )
		exports.mrp_global:applyAnimation( targetPlayer, "BLOWJOBZ", "BJ_Couch_Loop_W", -1, false, false, false )
	end
end
			...
			if otherPlayer then
				if (getPedOccupiedVehicle(thePlayer) == false and getPedOccupiedVehicle(otherPlayer) == false)  then
					...
					if (getDistanceBetweenPoints3D(x, y, z, tx, ty, tz)<1.5) then -- Are they standing next to each other?
						exports.mrp_global:applyAnimation( thePlayer, "GANGS", "prtial_hndshk_biz_01", -1, false, false, false)
						exports.mrp_global:applyAnimation( otherPlayer, "GANGS", "prtial_hndshk_biz_01", -1, false, false, false)
					else
...
--exports.mrp_global:applyAnimation(player, details.body, details.part, -1, false, false, false)
	end
)