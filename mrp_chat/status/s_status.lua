...
function sendStatus( thePlayer, commandName, ... )
	...
	exports["mrp_infobox"]:addBox(thePlayer, "success", "Başarılı bir şekilde /status durumunu etkinleştirdiniz.")
...
function sendToNearByClientsStatus(root, message)
	...
	for k, v in pairs(exports.mrp_pool:getPoolElementsByType("player")) do
