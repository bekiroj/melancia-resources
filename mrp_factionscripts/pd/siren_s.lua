function vehicleBlown()
	exports.mrp_anticheat:changeProtectedElementDataEx(source, "lspd:siren", false)
	setVehicleSirensOn ( source , false )
end
addEventHandler("onVehicleRespawn", getRootElement(), vehicleBlown)

function setSirenState()
	if exports.mrp_global:hasItem(source, 85) then -- sirens
		local curState = getElementData(source, "lspd:siren")
		exports.mrp_anticheat:changeProtectedElementDataEx(source, "lspd:siren", not curState)
