function startRappel(x, y, z, gz)
	...
	exports.mrp_anticheat:changeProtectedElementDataEx(source, "realinvehicle", 0, false)
	removePedFromVehicle(source)
	attachElements(source, invisible)
	moveObject(invisible, 2000, x, y, gz, 0, 0, 0)
	exports.mrp_pool:allocateElement(invisible)
	setTimer(stopRappel, 2000, 1, invisible, source, slot)
	exports.mrp_global:applyAnimation(source, "PARACHUTE", "PARA_float", true, 1.0, false, false)
	
	for key, value in ipairs(exports.mrp_global:getNearbyElements(invisible, "player", 100)) do
