	...
	if exports.mrp_integration:isPlayerSeniorAdmin( thePlayer ) then
		...
		if not houseID then
			...
			if entrance then
				...
				exports["mrp_interior_manager"]:addInteriorLogs(dbid, commandName, thePlayer)
...
function setInteriorID( thePlayer, commandName, interiorID )
	if exports.mrp_integration:isPlayerSeniorAdmin( thePlayer )  then
		local interiors = exports["mrp_official_interiors"].getInteriorsList() --/MAXIME
		...
		elseif not interiors[interiorID] then
			...
			if exit then
				...
				if query then
					...
					for key, value in pairs( exports.mrp_pool:getPoolElementsByType('player') ) do
					...
					exports.mrp_logs:dbLog(thePlayer, 4, { "in"..tostring(dbid) } , "SETINTERIORID "..interiorID)
					local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")
					local adminTitle = exports.mrp_global:getPlayerAdminTitle(thePlayer)
					local adminUsername = getElementData(thePlayer, "account:username")
					
					if hiddenAdmin == 0 then
						exports.mrp_global:sendMessageToAdmins("[INTERIOR]: "..adminTitle.." ".. getPlayerName(thePlayer):gsub("_", " ").." ("..adminUsername..") has changed interior of house #"..dbid.." to ID "..interiorID..".")
					else
						exports.mrp_global:sendMessageToAdmins("[INTERIOR]: A hidden admin has changed interior of house #"..dbid.." to ID "..interiorID..".")
					end
					
					exports["mrp_interior_manager"]:addInteriorLogs(dbid, commandName.." "..interiorID, thePlayer)
		...
		if not cost then
			...
			if exit then
				...
				if query then
					...
					exports.mrp_logs:logMessage("[/SETINTERIORPRICE] " .. getElementData(thePlayer, "account:username") .. "/".. getPlayerName(thePlayer) .." set the interiorprice of ".. dbid .." to ".. cost , 4)
					outputChatBox( "Interior cost is now $" .. exports.mrp_global:formatMoney(cost) .. ".", thePlayer, 0, 255, 0 )
					exports.mrp_logs:dbLog(thePlayer, 4, { "in"..tostring(dbid) } , "SETINTERIORPRICE "..cost)
					local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")
					local adminTitle = exports.global:getPlayerAdminTitle(thePlayer)
					local adminUsername = getElementData(thePlayer, "account:username")
					
					if hiddenAdmin == 0 then
						exports.mrp_global:sendMessageToAdmins("[INTERIOR]: "..adminTitle.." ".. getPlayerName(thePlayer):gsub("_", " ").." ("..adminUsername..") has changed interior price of house #"..dbid.." to $"..cost..".")
					else
						exports.mrp_global:sendMessageToAdmins("[INTERIOR]: A hidden admin has changed interior price of house #"..dbid.." to $"..cost..".")
					end
					
					exports["mrp_interior_manager"]:addInteriorLogs(dbid, commandName.." "..tostring(cost), thePlayer)
...
function getInteriorPrice( thePlayer )
	if exports.mrp_integration:isPlayerSeniorAdmin( thePlayer ) then
		...
		if exit then
			local interiorStatus = getElementData(interiorElement, "status")
			outputChatBox( "This Interior costs $" .. exports.mrp_global:formatMoney(interiorStatus[INTERIOR_COST]) .. ".", thePlayer, 255, 194, 14 )
		else
			outputChatBox( "You are not in an interior.", thePlayer, 255, 0, 0 )
		end
	end
			...
			if exit then
				if type ~= interiorType then
					...
					if query then
						...
						exports.mrp_logs:dbLog(thePlayer, 4, { "in"..tostring(dbid) } , "SETINTERIORTYPE "..type .. " (was "..interiorType.." / ".. interiorStatus[INTERIOR_OWNER] ..")")
						if type == 2 then
						...
						if hiddenAdmin == 0 then
							exports.mrp_global:sendMessageToAdmins("[INTERIOR]: "..adminTitle.." ".. getPlayerName(thePlayer):gsub("_", " ").." ("..adminUsername..") has changed interior type of house #"..dbid.." to type "..type..".")
						else
							exports.mrp_global:sendMessageToAdmins("[INTERIOR]: A hidden admin has changed interior type of house #"..dbid.." to type "..type..".")
						end
						exports.mrp_anticheat:changeProtectedElementDataEx(interiorElement, "status", interiorStatus, true)
						
						exports["mrp_interior_manager"]:addInteriorLogs(dbid, commandName.." "..tostring(type), thePlayer)
		...
		if not id then
			...
			if entrance then
				...
				if interiorStatus[INTERIOR_DISABLED] then
					...
					if hiddenAdmin == 0 then
						exports.mrp_global:sendMessageToAdmins("[INTERIOR]: "..adminTitle.." ".. getPlayerName(thePlayer):gsub("_", " ").." ("..adminUsername..") has enabled Interior #"..dbid..".")
					else
						exports.mrp_global:sendMessageToAdmins("[INTERIOR]: A hidden admin has enabled Interior #"..dbid..".")
					end
					
					exports["mrp_interior_manager"]:addInteriorLogs(dbid, commandName.." on", thePlayer)
				else
					...
					if hiddenAdmin == 0 then
						exports.mrp_global:sendMessageToAdmins("[INTERIOR]: "..adminTitle.." ".. getPlayerName(thePlayer):gsub("_", " ").." ("..adminUsername..") has disabled Interior #"..dbid..".")
					else
						exports.mrp_global:sendMessageToAdmins("[INTERIOR]: A hidden admin has disabled Interior #"..dbid..".")
					end
					
					exports["mrp_interior_manager"]:addInteriorLogs(dbid, commandName.." off", thePlayer)
				end
				realReloadInterior(dbid)
				exports.mrp_logs:dbLog(thePlayer, 4, { "in"..tostring(dbid) } , "TOGGLEINTERIOR "..dbid)
			end
		end
	end
end
				...
				if dbid ~= 0 then
					...
					for key, value in pairs( exports.mrp_pool:getPoolElementsByType('player') ) do
						if isElement( value ) and getElementDimension( value ) == dbid then
							...
							--exports.mrp_anticheat:changeProtectedElementDataEx( value, "interiormarker" )
							exports.mrp_anticheat:changeProtectedElementDataEx(value, "interiormarker", false, false, false)
					...
					if (query) then
						...
						exports.mrp_logs:dbLog(thePlayer, 4, { "in"..tostring(dbid) } , "DELETEINTERIOR "..dbid)
						if hiddenAdmin == 0 then
							exports.mrp_global:sendMessageToAdmins("[INTERIOR]: "..adminTitle.." ".. getPlayerName(thePlayer):gsub("_", " ") .. " has deleted Interior #"..dbid..".")
						else
							exports.mrp_global:sendMessageToAdmins("[INTERIOR]: A hidden admin has deleted Interior #"..dbid..".")
						end
							...
							if rows > 0 then
								for index, row in ipairs(res) do
									...
									if (query) then
										...
										exports.mrp_logs:dbLog(thePlayer, 4, { "in"..tostring(houseID) } , "RESTOREINT "..houseID)
										local adminUsername = getElementData(thePlayer, "account:username")
										local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")
										local adminTitle = exports.mrp_global:getPlayerAdminTitle(thePlayer)
										
										if hiddenAdmin == 0 then
											exports.mrp_global:sendMessageToAdmins("[INTERIOR]: "..adminTitle.." ".. getPlayerName(thePlayer):gsub("_", " ").. " ("..adminUsername..") has restored Interior #"..houseID..".")
										else
											exports.mrp_global:sendMessageToAdmins("[INTERIOR]: A hidden admin has restored Interior #"..houseID..".")
										end
										
										exports["mrp_interior_manager"]:addInteriorLogs(houseID, commandName, thePlayer)
...
addCommandHandler("moveinterior",
	function(player, cmd, interiorID)
		if (exports.mrp_integration:isPlayerHeadAdmin(player) or exports.mrp_integration:isPlayerScripter(player)) then
			local interiorID = tonumber(interiorID)
			x, y, z = getElementPosition(player)
			dbExec(exports.mrp_mysql:getConnection(), "UPDATE interiors SET x = ?, y = ?, z = ? WHERE id = ?", x, y, z, interiorID)
			outputChatBox(exports.mrp_pool:getServerSyntax(player, false,"s").."Mülkün giriş pozisyonu başarıyla ayarlandı.", player, 255, 255, 255, true)
...
function removeInterior(thePlayer, commandName, houseID)
	if exports.mrp_integration:isPlayerSeniorAdmin( thePlayer ) or commandName == "MOVETOLS" then
		if not showLoadingProgressTimer then	
							...
							if rows > 0 then
								for index, row in ipairs(res) do
									...
									if query1 and query2 then
										...
										exports.mrp_logs:dbLog(thePlayer, 4, { "in"..tostring(houseID) } , "REMOVEINT "..houseID)
										local adminUsername = getElementData(thePlayer, "account:username")
										local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")
										local adminTitle = exports.mrp_global:getPlayerAdminTitle(thePlayer)
										local adminID = getElementData(thePlayer, "account:id")
										if hiddenAdmin == 0 then
											exports.mrp_global:sendMessageToAdmins("[INTERIOR]: "..adminTitle.." ".. getPlayerName(thePlayer):gsub("_", " ").. " ("..adminUsername..") has removed Interior #"..houseID.." permanently from database.")
										else
											exports.mrp_global:sendMessageToAdmins("[INTERIOR]: A hidden admin has removed Interior #"..houseID.." permanently from database.")
										end
...
function cancelRemoveDeletedInts(thePlayer)
	if exports.mrp_integration:isPlayerSeniorAdmin( thePlayer ) and getElementData(thePlayer, "confirm:removeDeletedInteriors") then	
...
function cancelForceSellAllInactiveInteriors(thePlayer)
	if exports.mrp_integration:isPlayerSeniorAdmin( thePlayer ) and getElementData(thePlayer, "confirm:forceSellAllInactiveInteriors") then	
...
function cancelRemoveForSaleInts(thePlayer)
	if exports.mrp_integration:isPlayerSeniorAdmin( thePlayer ) and getElementData(thePlayer, "confirm:removeForSaleInteriors") then	
...
function cancelRemoveInactiveInteriors(thePlayer)
	if exports.mrp_integration:isPlayerSeniorAdmin( thePlayer ) and getElementData(thePlayer, "confirm:removeInactiveInteriors") then	
		...
		if not (intID) then
			...
			if entrance then
				...
				if (query) then
					...
					exports.mrp_logs:dbLog(thePlayer, 4, { "in"..tostring(dbid) } , "SETINTERIORENTRANCE ("..dw.."/"..iw..") "..x.."/"..y.."/"..z)
					local adminUsername = getElementData(thePlayer, "account:username")
					local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")
					local adminTitle = exports.mrp_global:getPlayerAdminTitle(thePlayer)
					
					if hiddenAdmin == 0 then
						exports.mrp_global:sendMessageToAdmins("[INTERIOR]: "..adminTitle.." ".. getPlayerName(thePlayer):gsub("_", " ").. " ("..adminUsername..") has moved Interior #"..dbid.." to new location.")
					else
						exports.mrp_global:sendMessageToAdmins("[INTERIOR]: A hidden admin has moved Interior #"..dbid.." to new location.")
					end
...
function createInterior(thePlayer, commandName, interiorId, inttype, cost, ...)
	if exports.mrp_integration:isPlayerSeniorAdmin( thePlayer ) then
		...
		elseif not exports.mrp_global:takeMoney(getTeamFromName("İstanbul Büyükşehir Belediyesi"), cost) then
			...
			if interior then
				...
				if (query) then
					...
					exports.mrp_logs:dbLog(thePlayer, 4, { "in"..tostring(id) } , "ADDINTERIOR T:".. inttype .." I:"..interiorId.." C:"..cost)
					...
					if hiddenAdmin == 0 then
						exports.mrp_global:sendMessageToAdmins("[INTERIOR]: "..adminTitle.." ".. getPlayerName(thePlayer):gsub("_", " ").. " ("..adminUsername..") has created Interior #"..id.." with name '"..name.."', type "..inttype..", price: $"..cost..").")
					else
						exports.mrp_global:sendMessageToAdmins("[INTERIOR]: A hidden admin has created Interior #"..id.." with name '"..name.."', type "..inttype..", price: $"..cost..").")
					end
					
					exports["mrp_interior_manager"]:addInteriorLogs(id, commandName.." - id "..interiorId.." - price $"..cost.." - name "..name, thePlayer)
...
function updateInteriorExit(thePlayer, commandName)
	if exports.mrp_integration:isPlayerSeniorAdmin( thePlayer )  then
		...
		if (dimension==0) then
			...
			exports.mrp_logs:dbLog(thePlayer, 4, { "in"..tostring(dbid) } , "SETINTERIOREXIT "..x.."/"..y.."/"..z)
...
function changeInteriorName( thePlayer, commandName, ...)
	if (exports.mrp_integration:isPlayerSeniorAdmin(thePlayer)) then -- Is the player an admin?
		...
		elseif (dimension==0) then
			...
			exports.mrp_logs:dbLog(thePlayer, 4, { "in"..tostring(dbid) } , "SETINTERIORNAME '"..name.."'")
			local adminUsername = getElementData(thePlayer, "account:username")
			local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")
			local adminTitle = exports.mrp_global:getPlayerAdminTitle(thePlayer)
			
			if hiddenAdmin == 0 then
				exports.mrp_global:sendMessageToAdmins("[INTERIOR]: "..adminTitle.." ".. getPlayerName(thePlayer):gsub("_", " ").. " ("..adminUsername..") has changed Interior #"..id.."'s name to '"..name.."'.")
			else
				exports.mrp_global:sendMessageToAdmins("[INTERIOR]: A hidden admin has changed Interior #"..id.."'s name to '"..name.."'.")
			end
			
			
			exports["mrp_interior_manager"]:addInteriorLogs(id, commandName.." "..name, thePlayer)
...
function forceSellProperty(thePlayer, commandName, intID)
	if exports.mrp_integration:isPlayerSeniorAdmin(thePlayer)  then
		...
		elseif interiorStatus[INTERIOR_OWNER] < 1 and interiorStatus[INTERIOR_FACTION] < 1 then
			...
			exports.mrp_logs:dbLog(thePlayer, 37, { "in"..tostring(intID) } , "FORCESELL "..intID)
			exports["mrp_interior_manager"]:addInteriorLogs(intID, commandName, thePlayer)
