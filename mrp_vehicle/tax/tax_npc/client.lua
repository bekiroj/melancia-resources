function VergiGUI(Data)
    ...
    vergiPanelWindow = guiCreateWindow(scaleW * 426, scaleH * 205, scaleW * 513, scaleH * 359, "Melancia - Araç Vergi Sistemi", false)
	...
	for i, data in ipairs(Data) do
		...
		guiGridListSetItemText(vergiPanelGrid, row, 3, "₺" .. exports.mrp_global:formatMoney(data[3]), false, false)
	end
