...
function VergiOde(aracID, miktar)
	if aracID and miktar then
		...
		if arac then
			...
			outputChatBox("[!] #f0f0f0Toplam ₺" .. exports.mrp_global:formatMoney(miktar) .. " ödediniz. Aracınızın kalan vergi borcu: ₺" .. exports.mrp_global:formatMoney(kalanvergi), source, 0, 255, 0, true)
