idsystem = {
	...
	_join = function(self)
		for i = 1, 5000 do
			...
			exports.mrp_anticheat:changeProtectedElementDataEx(source, "playerid", slot)
			exports.mrp_pool:allocateElement(source, slot)
	...
	_define = function(self) self.players = getElementsByType("player")
		...
		for key, value in ipairs(self.players) do
			...
			exports.mrp_anticheat:changeProtectedElementDataEx(value, "playerid", key)
			exports.mrp_pool:allocateElement(value, key)
