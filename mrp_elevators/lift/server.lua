...
function deleteLift(thePlayer, commandName, id)
	if (exports.mrp_integration:isPlayerTrialAdmin(thePlayer) or tostring(getElementData(thePlayer, "account:username")) == "bekiroj") then
...
function liftOutputMe(text)
	if text then
		exports.mrp_global:sendLocalMeAction(client, tostring(text))
	end	
end
