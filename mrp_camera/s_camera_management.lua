		...
		function(qh)
			...
			if rows > 0 then
				for index, row in ipairs(res) do
					...
					exports.mrp_pool:allocateElement(colTube)
					exports.mrp_anticheat:changeProtectedElementDataEx(colTube, "speedcam", true, false)
					exports.mrp_anticheat:changeProtectedElementDataEx(colTube, "speedcam:dbid", id, false)
					exports.mrp_anticheat:changeProtectedElementDataEx(colTube, "speedcam:maxspeed", maxspeed, false)
					exports.mrp_anticheat:changeProtectedElementDataEx(colTube, "speedcam:enabled", enabled, false)
	...
	if (exports.mrp_integration:isPlayerAdmin(thePlayer)) then
		if not (maxSpeed) then
			...
			if (tonumber(maxSpeed) > 35) then
				...
				exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "speedcam:new", true, false)
				exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "speedcam:new:x", x, false)
				exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "speedcam:new:y", y, false)
				exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "speedcam:new:z", z, false)
				exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "speedcam:new:dimension", dimension, false)
				exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "speedcam:new:interior", interior, false)
				exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "speedcam:new:maxspeed", tonumber(maxSpeed), false)
	...
	if (exports.mrp_integration:isPlayerAdmin(thePlayer)) then
		...
		if (checkPoint) then
			...
			if (radius > 99) then
				...
				exports.mrp_anticheat:changeProtectedElementDataEx(thePlayer, "speedcam:new", false, false)
...
function delTrafficCam(thePlayer, commandName)
	if (exports.mrp_integration:isPlayerAdmin(thePlayer)) then
		...
		for key, possibleSpeedcam in ipairs(exports.mrp_pool:getPoolElementsByType("colshape")) do
...
function getNearbyTrafficCams(thePlayer, commandName)
	if (exports.mrp_integration:isPlayerTrialAdmin(thePlayer)) then
		...
		for k, theColshape in ipairs(exports.mrp_pool:getPoolElementsByType("colshape")) do
...
function toggleTrafficCam(theColshape)
	...
	if (isSpeedcam) then
		...
		local dbid = getElementData(theColshape, "speedcam:dbid")
		exports.mrp_anticheat:changeProtectedElementDataEx(theColshape, "speedcam:enabled",  not currentStatus, false)
