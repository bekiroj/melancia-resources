...
function newGate(thePlayer, commandName, itemID)
	if exports.mrp_integration:isPlayerAdmin(thePlayer) then
		...
		if tempObject then
			...
			exports.mrp_anticheat:changeProtectedElementDataEx(tempObject, "gate:parameters", tempTable, false)
			exports.mrp_anticheat:changeProtectedElementDataEx(tempObject, "gate:id", -1, false)
			exports.mrp_anticheat:changeProtectedElementDataEx(tempObject, "gate:edit", true, false)
...
function startGateSystem(res)
	...
	mysql:getConnection(), "SELECT `id` FROM `gates` ORDER BY `id` ASC")
end
...
function loadOneGate(gateID)
			...
			if rows > 0 then
				for index, row in ipairs(res) do
					...
					if tempObject then
						...
						exports.mrp_anticheat:changeProtectedElementDataEx(tempObject, "gate:parameters", tempTable, false)
						exports.mrp_anticheat:changeProtectedElementDataEx(tempObject, "gate:id", row["id"], true)
						exports.mrp_anticheat:changeProtectedElementDataEx(tempObject, "gate:edit", false, false)
						exports.mrp_anticheat:changeProtectedElementDataEx(tempObject, "gate:busy", false, false)
						exports.mrp_anticheat:changeProtectedElementDataEx(tempObject, "gate", true, true)
						...
						exports.mrp_anticheat:changeProtectedElementDataEx(tempObject, "gate:triggerDistance", triggerDistance, true)
						exports.mrp_anticheat:changeProtectedElementDataEx(tempObject, "gate:triggerDistanceVehicle", triggerDistanceVehicle, true)
						exports.mrp_anticheat:changeProtectedElementDataEx(tempObject, "gate:sound", gateSound, true)
	...
	mysql:getConnection(), "SELECT * FROM `gates` WHERE `id`='"..tostring(gateID).."'")
end
...
function createGate(model,x,y,z,rx,ry,rz,x2,y2,z2,rx2,ry2,rz2,int,dim,autocloseTime,movementTime,gateType,securityParameters,triggerDistance,triggerDistanceVehicle,sound)
	...
	if tempObject then
		...
		exports.mrp_anticheat:changeProtectedElementDataEx(tempObject, "gate:triggerDistance", triggerDistance, true)
		exports.mrp_anticheat:changeProtectedElementDataEx(tempObject, "gate:triggerDistanceVehicle", triggerDistanceVehicle, true)
		exports.mrp_anticheat:changeProtectedElementDataEx(tempObject, "gate:sound", sound, false)
