...
function restrainPlayer(player, restrainedObj)
	...
	exports.mrp_global:takeItem(source, restrainedObj)

	if (restrainedObj==45) then -- If handcuffs.. give the key
		exports['mrp_items']:deleteAll(47, dbid)
		exports.mrp_global:giveItem(source, 47, dbid)
	end
...
function unrestrainPlayer(player, restrainedObj)
	...
	exports.mrp_global:giveItem(source, restrainedObj, 1)
...
function blindfoldPlayer(player)
	...
	exports.mrp_global:takeItem(source, 66) -- take their blindfold
...
function removeblindfoldPlayer(player)
	...
	exports.mrp_global:giveItem(source, 66, 1) -- give the remove the blindfold
...
function stabilizePlayer(player)
	local found, slot, itemValue = exports.mrp_global:hasItem(source, 70)
	if found then
		if itemValue > 1 then
			exports['mrp_items']:updateItemValue(source, slot, itemValue - 1)
		else
			exports.mrp_global:takeItem(source, 70, itemValue)
		end
