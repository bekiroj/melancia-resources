...
function showAdminJailCounter()
	...
	if jailtime and (tonumber(jailtime) and tonumber(jailtime) > 0) or jailtime == "permanently" then
	    ...
	    dxDrawText("Melancia - OOC Ceza Sistemi", 630-xo, 38-yo, 872-xo, 76-yo, tocolor(255, 255, 255, 255), 1.00, RobotoFont, "center", "center", false, false, true, false, false)
	    ...
	    dxDrawText(tonumber(currentSecs) and exports.mrp_datetime:formatSeconds(currentSecs) or jailtime, 563-xo, 59-yo, 945-xo, 100-yo, tocolor(235, 146, 41, 255), 1.00, RobotoFont, "center", "center", false, false, true, false, false)
