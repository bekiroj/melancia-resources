...
--
function WebWindow:constructor(pos, size, initialPage, transparent, browserPos, browserSize, IsLocal,pgui)
...
--
function WebWindow:destroy() if not self.m_Browser then return false end;
	-- Unlink from manager
...
--
function WebWindow:executeJavascript2(code)
	if not self.m_Browser then return false end
