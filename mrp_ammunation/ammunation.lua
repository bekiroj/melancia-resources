...
function mermiOnayla(thePlayer, cmd)
	...
	if mermiTutari then
		if exports.mrp_global:hasMoney(thePlayer, mermiTutari) then
			...
			exports.mrp_global:takeMoney(thePlayer, mermiTutari)
			for i = 1, sarjorMiktari do
				give, error = exports.mrp_global:giveItem(thePlayer, 116, silahTuru..":"..mermiMiktari..":Ammo for "..getWeaponNameFromID(silahTuru))
			end
