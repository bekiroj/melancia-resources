function editVehicle(thePlayer, commandName)
	if exports.mrp_integration:isPlayerVehicleConsultant(thePlayer) or exports.mrp_integration:isPlayerSeniorAdmin(thePlayer) or exports.mrp_integration:isPlayerVCTMember(thePlayer) then
		...
		exports.mrp_logs:dbLog(thePlayer, 4, { theVehicle, thePlayer }, commandName)
		return true
	end
end
...
function createUniqueVehicle(data, existed)
	...
	local vehicle = exports.mrp_pool:getElement("vehicle", tonumber(data.id))
	...
	if not existed then
		...
		exports.mrp_logs:dbLog(client, 6, { client }, " Created unique vehicle #"..data.id..".")
		exports.mrp_global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(client, "account:username").." has created new unique vehicle #"..data.id..".")
		exports["mrp_vehicle"]:reloadVehicle(tonumber(data.id))
		...
		exports.mrp_logs:dbLog(client, 6, { client }, " Updated unique vehicle #"..data.id..".")
		exports.mrp_global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(client, "account:username").." has updated unique vehicle #"..data.id..".")
		exports["mrp_vehicle"]:reloadVehicle(tonumber(data.id))
		return true
	end
end
...
function resetUniqueVehicle(vehID)
	...
	exports.mrp_logs:dbLog(client, 6, { client }, " Removed unique vehicle #"..vehID..".")
	exports.mrp_global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(client, "account:username").." has removed unique vehicle #"..vehID..".")
	exports["mrp_vehicle"]:reloadVehicle(tonumber(vehID))

	local vehicle = exports.mrp_pool:getElement("vehicle", tonumber(vehID))
...
function openUniqueHandling(vehdbid, existed)
	if exports.mrp_integration:isPlayerVehicleConsultant(client) or exports.mrp_integration:isPlayerSeniorAdmin(client) then
