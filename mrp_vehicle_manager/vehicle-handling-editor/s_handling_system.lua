...
function deleteUniqueHandling(theVehicle, player)
	...
	if dbid and tonumber(dbid) then
		...
		if existed then
			...
			exports.mrp_logs:dbLog(player, 6, { player, theVehicle }, " Reset unique handling for vehicle #"..dbid..".")
			exports.mrp_global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(player, "account:username").." has reset unique handling for vehicle #"..dbid..".")
			exports["mrp_vehicle"]:reloadVehicle(tonumber(dbid))
...
function saveHandling(theVehicle1, saveToSQL, who)
	...
	if saveToSQL == 0 then -- SAVE TO ALL INSTANCES
		...
		exports.mrp_logs:dbLog(who, 6, { who }, "CHANGED HANDLINGS OF ALL INSTANCES OF VEHICLE SHOP ID #"..id)
		exports.mrp_global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(who, "account:username").." has changed handlings of all instances of vehicle shop id #"..id)
	...
	elseif saveToSQL == 1 then --SAVE TO 1 INSTANCE (UNIQUE)
		...
		dbQuery(
			function(qh, who)
				...
				if res > 0 then
					local row = res[1]
					local veh = exports.mrp_pool:getElement('vehicle', tonumber(dbid))
					...
					exports.mrp_logs:dbLog(who, 6, { who, theVehicle1 }, " SAVED UNIQUE HANDLINGS FOR VEHICLE ID #"..dbid)
					exports.mrp_global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(who, "account:username").." saved unique handlings for vehicle id #"..dbid)
				end
			end,
...
function reloadAllInstancesOf(vehicle_shop_id)
	...
	exports.mrp_logs:dbLog(client, 6, { client }, "RELOADED "..count.." INSTANCES OF VEHICLE SHOP ID #"..vehicle_shop_id.." IN GAME")
	exports.mrp_global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(client, "account:username").." has reloaded "..count.." instances of vehicle shop id #"..vehicle_shop_id.." in game.")
end
...
function getInfoFromVehShopID(vehShopID)
	...
	--local query = dbQuery(exports.mrp_mysql:getConnection(), "SELECT * FROM `vehicles_shop` WHERE `id` ='"..vehShopID.."'")	
...
function createTestVehicle(vehShopID, thePed, fromVehLib)
	...
	if not fromVehLib then
		if exports.mrp_global:takeMoney(client, 25) then
			exports.mrp_global:sendLocalText(client, "* "..exports.mrp_global:getPlayerName(client).." gives "..getElementData(thePed, "name").." some money.", 255, 51, 102, 30, {}, true)
		else
	...
	exports.mrp_global:fadeToBlack(client)
	...
	exports.mrp_anticheat:changeProtectedElementDataEx(client, "realinvehicle", 0, false)
	...
	exports.mrp_anticheat:changeProtectedElementDataEx(veh, "dbid", dbid)
	exports.mrp_anticheat:changeProtectedElementDataEx(veh, "fuel", exports["mrp_vehicle_fuel"]:getMaxFuel(veh), false)
	...
	exports.mrp_anticheat:changeProtectedElementDataEx(veh, "owner", -1, false)
	exports.mrp_anticheat:changeProtectedElementDataEx(veh, "job", 0, false)
	...
	exports.mrp_anticheat:changeProtectedElementDataEx(veh, "model", vehShopData.vehmodel, true)
	...
	exports.mrp_anticheat:changeProtectedElementDataEx(veh, "isTestDriveCar", client)
	
	exports['mrp_vehicle_interiors']:add( veh )
	
	exports.mrp_anticheat:changeProtectedElementDataEx(client, "testdrivepos", savepos , false)
...
function finishTestDrive(veh, thePed, orderFinish, forSpawn)
	...
	for i = 0, getVehicleMaxPassengers( veh ) do
		...
		if player then
			...
			exports.mrp_anticheat:changeProtectedElementDataEx(player, "realinvehicle", 0, false)
			...
			if savedpos and (not forSpawn or player ~= client) then
				...
				setTimer(function ()
					exports.mrp_global:fadeFromBlack(player)
				end, 2000, 1)
				found = true
				break
			end
	...
	if not found and not forSpawn then
		...
		if savedpos then
			...
			setTimer(function ()
				exports.mrp_global:fadeFromBlack(client)
			end, 2000, 1)
		end
	end
...
function orderVehicle(vehShopID, thePed)
	...
	exports.mrp_anticheat:changeProtectedElementDataEx(source, "carshop:grotti:orderedvehicle:"..getElementData(thePed,"carshop"), tonumber(vehShopID), true)
...
function cancelOrderVehicle(shopname)
	if shopname then
		exports.mrp_anticheat:changeProtectedElementDataEx(client, "carshop:grotti:orderedvehicle:"..shopname, false, true)
	else
	--[[
		for i, v in pairs(exports["mrp_vehicle_shop"]:getCarShops()) do
			exports.mrp_anticheat:changeProtectedElementDataEx(client, "carshop:grotti:orderedvehicle:"..(v.name), false)
		end
		]]
	end
end
