...
addEventHandler("korna:gui", root,
	function()
		...
		kornaGUI = guiCreateWindow(0, 0, 612, 348, "Melancia - Havalı Korna Sistemi", false)
		guiWindowSetSizable(kornaGUI, false)
		exports.mrp_global:centerWindow(kornaGUI)
		...
		for index, v in ipairs(kornas) do
			...
			guiGridListSetItemText(gridlist, row, 2, exports.mrp_global:formatMoney(v[3]).." ", false, false)
		end
