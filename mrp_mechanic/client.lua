...
addEventHandler("mechanic:gui", root,
    function()
        self.window[1] = guiCreateWindow(578, 351, 767, 409, "Melancia - Mekanik Arayüzü", false)
        ...
        guiGridListSetItemText(self.gridlist[1], 13, 1, "Melancia - Scripting Team", false, false)    
    end
)
