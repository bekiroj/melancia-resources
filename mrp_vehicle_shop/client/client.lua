...
GUIEditor = {
	...
	gui["_root"] = guiCreateWindow(0, 0, 349, 164, "Araç Satın Alma Ekranı - Melancia", false)
	guiWindowSetSizable(gui["_root"], false)
	exports.mrp_global:centerWindow(gui["_root"])
	...
	if exports.mrp_global:hasItem(localPlayer, 263, 1) and carPrice < 25000 then
...
function carshop_buyCar_click()
	if exports.mrp_global:hasSpaceForItem(getLocalPlayer(), 3, 1) then
